class iStarTask {
    ...
    initObject() {
        ...
        this.line1 = new fabric.Line([this.width / 6, 0, 0, this.height/2], {
            fill: 'black',
            stroke: 'black',
            strokeWidth: this.strokeWidth
            
        });
        this.line2 = new fabric.Line([0, this.height / 2, this.width/6, this.height], {
            fill: 'black',
            stroke: 'black',
            strokeWidth: this.strokeWidth

        });
        this.line3 = new fabric.Line([this.width/6, this.height, this.width / 6*5, this.height], {
            fill: 'black',
            stroke: 'black',
            strokeWidth: this.strokeWidth

        });
        this.line4 = new fabric.Line([this.width / 6 * 5, this.height, this.width, this.height/2], {
            fill: 'black',
            stroke: 'black',
            strokeWidth: this.strokeWidth

        });
        this.line5 = new fabric.Line([this.width, this.height / 2, this.width/6*5,0], {
            fill: 'black',
            stroke: 'black',
            strokeWidth: this.strokeWidth

        });
        this.line6 = new fabric.Line([this.width / 6 * 5, 0, this.width/6,0], {
            fill: 'black',
            stroke: 'black',
            strokeWidth: this.strokeWidth
    ...
    draw(canvas) {
        this.group1 = new fabric.Group([this.head, this.nameText, this.left, this.right, this.line1, this.line2, this.line3, this.line4, this.line5, this.line6], {
            left: 0,
            top:0
