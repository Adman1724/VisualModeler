class iStarAgent {
    ...
    initObject() {
        ...
        var long = Math.sqrt(((this.height / 2) * (this.height / 2)) - ((this.height / 3) * (this.height / 3)));
        this.line1 = new fabric.Line([0, 0 - this.height / 3, long, 0 - this.height/3], {
            fill: 'black',
            stroke: 'black',
            strokeWidth: this.strokeWidth,
            originX: 'center',
        ...
        this.line2 = new fabric.Line([0, 0 - this.height / 3, 0-long , 0-this.height / 3], {
            fill: 'black',
            stroke: 'black',
            strokeWidth: this.strokeWidth,
            originX: 'center',
    ...
    draw(canvas) {
        this.group3 = new fabric.Group([this.nameText], {
            originX: 'center',
            originY: 'center'
        });
        this.group2 = new fabric.Group([this.head], {});

        this.group1 = new fabric.Group([this.group2, this.group3, this.line1,this.line2], {
            top: 0,
            left:0
        });
