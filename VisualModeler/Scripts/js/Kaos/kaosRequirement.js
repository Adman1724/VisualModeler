class kaosRequirement {
    ...
    initObject() {
        ...
        this.line1 = new fabric.Line([this.width, 0, this.width / 4, 0], {
            fill: 'black',
            stroke: 'black',
            strokeWidth: this.strokeWidth
        ...
        this.line3 = new fabric.Line([this.width, 0, this.width / 4 * 3, this.height], {
            fill: 'black',
            stroke: 'black',
            strokeWidth: this.strokeWidth

        });
        this.line4 = new fabric.Line([this.width / 4 * 3, this.height, 0, this.height ], {
            fill: 'black',
            stroke: 'black',
            strokeWidth: this.strokeWidth

        });
        this.line5 = new fabric.Line([0, this.height , this.width /4, 0], {
            fill: 'black',
            stroke: 'black',
            strokeWidth: this.strokeWidth
    ...
    draw(canvas) {
        this.group1 = new fabric.Group([this.left, this.right,this.head, this.line1, this.line3, this.line4, this.line5, this.nameText], {
            left: 0,
            top: 0
